<%@ Page Title="" Language="C#" MasterPageFile="~/UC/MasterPage.master" AutoEventWireup="true" CodeFile="Sachtheonhaxuatban.aspx.cs" Inherits="Sachtheonhaxuatban" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <p class="text-center text-danger">
		Sách Theo Nhà Xuất Bản: <asp:Label ID="lbNhaXB" runat="server" Text=""></asp:Label>
	</p>
